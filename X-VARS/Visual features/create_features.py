...
if __name__ == '__main__':
    ...
    parser.add_argument('--path_dataset',   required=True, type=str, help='Path to the dataset folder' )
    parser.add_argument('--path_weights',   required=True, type=str, help='Path to CLIP weights' )
